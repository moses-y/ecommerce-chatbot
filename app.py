...
theme = gr.themes.Soft(
    ...
    body_background_fill="#E0F7FA",
    background_fill_primary="rgba(224, 247, 250, 0.4)",
    background_fill_secondary="rgba(224, 247, 250, 0.35)",
    border_color_primary="rgba(255, 255, 255, 0.2)",
    button_primary_background_fill="rgba(129, 212, 250, 0.8)",
    button_primary_background_fill_hover="rgba(129, 212, 250, 1)",
...
:root {
    --primary: #81D4FA;
    --primary-light: rgba(129,212,250,0.3);
    --secondary: #4FC3F7;
    --text-primary: #403E3D;
...
def track_order(order_id: str, state: Dict[str, Any]) -> Tuple[List[Tuple[str, str]], Dict[str, Any], str]:
    ...
    try:
        ...
        messages, updated_state = next(processed)
...
with gr.Blocks(theme=theme, css=css) as demo:
    ...
    track_btn.click(
        ...
        outputs=[chatbot, state, order_input],
        api_name="track"
